...
public interface STProjectMapper {
    ...
    String condition = "" +
            ...
            "<if test='userIn!=null'> and id in (select project_id from ST_PROJECT_USER where user_name=#{userIn})</if>";
    ...
    @Select({
            ...
            "</script>"})
    List<STProject> select(Query query);
