...
@Controller
public class ZDDataLoginController {
    ...
    public DataResult data_login(HttpServletResponse response, ZDUser zdUser) {
        ...
        ZDUser zdUser1 = zdUserService.find(query).singleResult();
        if (zdUser1 == null) {
